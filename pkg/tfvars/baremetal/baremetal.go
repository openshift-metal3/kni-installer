...
func TFVars(libvirtURI, ironicURI, inspectorURI, osImage, externalBridge, provisioningBridge string, platformHosts []*baremetal.Host, image baremetal.Image) ([]byte, error) {
